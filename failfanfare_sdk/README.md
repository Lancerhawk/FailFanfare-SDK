...
FailFanfare is a dual-mode SDK that plays high-fidelity audio cues in response to terminal and browser events. It's designed to keep you focused, entertained, and instantly aware of build failures or runtime crashes.
...
```json
{
  "failfanfare": {
    ...
    "runtime": "./public/runtime-fail.mp3"
  }
}
```
